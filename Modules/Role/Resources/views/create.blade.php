                ...
                <div class="card mb-4">
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <h6 class="fs-17 fw-semi-bold mb-0">{{__("Create Role")}}</h6>
                            </div>

                            <div class="text-end">
                                <div class="actions">
                                    <a href="#" class="action-item"><i class="ti-reload"></i></a>
                                    <a href="{{route('roles.index')}}" class="btn btn-success btn-sm"><i class="fa fa-list"></i>&nbsp{{__('Role List')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="col-md-4 offset-md-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="role_id" class="form-control role-form" placeholder="Role Name" required/>
...
@endsection
@push('js')
{{-- <script src="{{ asset('Modules/Role/Public/assets/js/user-assign-script.js')}}"></script> --}}
